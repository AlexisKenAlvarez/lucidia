...
const Hero = () => {
    ...
    return (
        <section className="w-full h-screen px-5 py-10 relative text-white flex items-center justify-center">
            <img src="/hero/herobg.webp" alt="Herobg" className="w-full h-full object-cover absolute top-0 left-0" />

            <div className="max-w-[1400px] w-full h-auto mx-auto relative z-10 flex mt-[10rem]">

                <div className="w-full">
                    <h1 className="font-primary text-[72px] max-w-[40rem] leading-[5.5rem] font-semibold">AI DRIVEN GAMEFI GOVERNED BY YOU</h1>

                    <div className=" max-w-[37rem] font-primary font-medium flex flex-col gap-y-5">
                    ...
                    <div className="flex gap-x-3 mt-10">
                        <button className="w-[9rem] h-14 clipped2 bg-cyan relative  font-bold flex items-center justify-center scale-x-[-1]">
                        ...
                        <button className="w-[13rem] h-14 clipped2 bg-white relative  font-bold flex items-center justify-center scale-x-[-1]">
                    ...
                    <div className="mt-20 flex items-center gap-x-8">
                        <div className="">
                ...
                <div className="w-full relative">
                    <img src="/hero/hero.webp" alt="Hero" className="object-cover top-0 -mt-4 h-[70vh] mx-auto" />
                </div>
