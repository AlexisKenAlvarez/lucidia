    ...
    const data = [
        {
            ...
            value: [
                <li>Go to <a href="https://moonpay.com/buy" target="-blank" rel="noopener noreferrer" className="text-grn">https://moonpay.com/buy</a> and purchase ETH or BNB using your card. The purchased ETH or BNB will be sent to your wallet. It is recommended to buy a minimum of $20 worth of ETH or $5 worth of BNB to cover the minimum purchase of $LUCID tokens.</li>,
                <li>Enter the amount you wish to invest</li>,
                <li>Choose your bonus option - it will be available one month after TGE</li>
            ]
        },
        {
            title: "Option 2: Buy $LUCID with ETH or BNB",
            value: [
                <li>Ensure you have enough ETH or BNB in your wallet &#40;if not, refer to option 1&#41;. Enter the amount of $LUCID you want to purchase &#40;minimum $15&#41; and click Buy with ETH or Buy with BNB. Confirm the transaction in your wallet and review the gas cost</li>,
                <li>Enter the amount you wish to invest</li>,
                <li>Choose your bonus option - it will be available one month after TGE</li>
            ]
        },
        {
            ...
            value: [
                <li>Make sure you have at least $20 worth of USDT in your wallet.</li>,
                <li>Enter the amount you wish to invest</li>,
                <li>Choose your bonus option - it will be available one month after TGE</li>,
                <li>You will need to approve the purchase twice. The first approval is for the USDT contract, and the second is for the transaction amount. Complete both approval steps to finalize the transaction.</li>
            ]
        }
    ];

    return (
        <section className="w-full min-h-screen relative px-5 py-10 pt-28">
            <div className="max-w-[1400px] w-full mx-auto flex gap-x-32 justify-center">

                <div className="w-[28%] text-white ">
                    <h1 className="font-semibold text-transparent text-2xl sm:ext-3xl md:text-4xl font-primary bg-clip-text bg-gradient-to-r from-white via-[#cab8ff] to-white max-w-[12rem]">How to buy $LUCID?</h1>
                    ...
                    <img src="/coins.webp" alt="Coins" className="mt-16 w-[39rem]" />
                </div>
                <div className="w-[58.9%] flex flex-col gap-y-5">

                    <div className="w-full h-auto clipped2 bg-gry relative  font-bold flex items-center justify-center scale-x-[-1] rounded-md">
                        <div className="scale-x-[-1] text-white w-full h-full p-5 border-l-[0.5rem] border-grn rounded-md">
                    ...
                    <div className="w-full h-auto clipped2 bg-gry relative flex items-center justify-center scale-x-[-1] rounded-md">
                        <div className="scale-x-[-1] text-white w-full h-full p-5 pb-6 border-l-[0.5rem] border-grn rounded-md">
                    ...
                    <div className="w-full h-auto clipped2 bg-gry relative flex items-center justify-center scale-x-[-1] rounded-md">
                        <div className="scale-x-[-1] text-white w-full h-full p-5 pb-6 border-l-[0.5rem] border-grn rounded-md font-primary font-medium">
