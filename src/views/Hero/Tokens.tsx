...
const Tokens = () => {
    ...
    return (
        <section className="w-full h-auto px-5 py-10 bg-bg relative">
            <div className="max-w-[1400px] mx-auto w-full h-auto">
                <h1 className="font-medium text-center text-transparent text-2xl sm:text-3xl md:text-4xl font-primary  "><span className="bg-clip-text bg-gradient-to-r from-white via-[#cab8ff] to-white">Earn $LUCID?</span><span className="bg-clip-text bg-gradient-to-r from-white to-lavender"> Tokens</span></h1>
