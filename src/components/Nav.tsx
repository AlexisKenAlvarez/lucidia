const Nav = () => {
    ...
    return (
        <nav className="w-full h-auto py-4 absolute top-0 left-0 z-20 px-5">
            <img src="/hero/navline.webp" alt="NavLine" className="w-full absolute left-0 top-7 right-0" />
            ...
            <div className="max-w-[1400px] w-full mx-auto flex justify-between items-center mt-5">
                ...
                <ul className="font-secondary font-semibold text-sm uppercase flex items-center gap-x-12 text-white">
                    {navList.map((items, i) => {
                        return (
                ...
                <div className="flex items-center gap-x-8">
                    ...
                    <button className="w-[13rem] h-9 clipped bg-bl relative  font-bold flex items-center justify-center">
